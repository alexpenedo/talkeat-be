...
export class MenusController {
    ...
    @Get()
    async findByParams(@Query() params: FindParams) {
        if (params.host && params.status) {
            ...
            return this.menuService.findUserMenus(params.latitude, params.longitude, params.date, params.type, params.persons);
        }
    }
